...
export async function uploadDocument(input: {
  ...
  if (USE_MOCK) {
    ...
    const doc: Document = {
      ...
      // Phase 9: real thumbnails are generated by RQ workers; mock marks intent.
      thumbnail_path: isImage ? `mock://${id}/thumb` : null,
      resized_path: isImage ? `mock://${id}/resized` : null,
      category,
